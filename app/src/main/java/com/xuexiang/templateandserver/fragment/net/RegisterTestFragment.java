 ...
 */
@Page
public class RegisterTestFragment extends BaseFragment {
    ...
    private void handleSubmit() {
        ...
        request.apiCall(request.create(TestApi.UserService.class).register(user), new TipProgressLoadingCallBack<Boolean>(this) {
            @Override
